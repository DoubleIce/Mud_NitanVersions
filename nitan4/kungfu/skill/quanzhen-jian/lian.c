...
//        ap=me->query("combat_exp")/1000+me->query_skill("sword",1)+me->query_skill("unarmed",1);
        ap=atoi(count_div(me->query("combat_exp"),1000))+me->query_skill("sword",1)+me->query_skill("unarmed",1);
        dp=atoi(count_div(target->query("combat_exp"),1000))+target->query_skill("parry",1);
