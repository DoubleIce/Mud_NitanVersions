...
mapping query_action(object me)
{
	...
	if (me->query_skill_mapped("force") == "hamagong" ) {
                if ( !me->query_temp("hmg_dzjm") && me->query_temp("powerup") && random(me->query_skill("force", 1)) > 250 && me->query("neili") > 1000 && me->query("jiali") > 100)
			return ([
			...
			"damage_type": random(2)?"内伤":"瘀伤"
                ...
                else if ( me->query_temp("reverse") && random(me->query_skill("force", 1)) > 400  && random(me->query_skill("strike", 1)) > 300 && me->query("neili") > 1000 )
			return ([
