...
int perform(object me, object target)
{
        ...
        {
                if (flag) damage = damage_power(me, "sword") / 4;
                else damage = damage_power(me, "blade") / 4;
        ...
        if (flag)ap = attack_power(me, "sword") + me->query("int") * 20;
        else ap = attack_power(me, "blade") + me->query("int") * 20;
        // 第二招，判断对方悟性
        dp = defense_power(target, "parry") + target->query("int") * 20;
