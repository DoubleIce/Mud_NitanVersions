...
int perform(object me, object target)
{
 ...
 //               if (me->query("combat_exp")*3 > target->query("combat_exp")*4) 
                if (count_gt(count_mul(me->query("combat_exp"),3), count_mul(target->query("combat_exp"),4))) 
...
//                        if (me->query("combat_exp") < random(target->query("combat_exp")*8/5)) {
                        if (count_lt(count_div(me->query("combat_exp"),100), count_div(count_mul(random(atoi(count_div(target->query("combat_exp"),100))), 8), 5))) {
