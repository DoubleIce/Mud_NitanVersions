...
//  if( random( me->query("combat_exp") ) > random( target->query("combat_exp")*2 ) || 
  if( random( atoi(count_div(me->query("combat_exp"),100) )) > random( atoi(count_div(target->query("combat_exp"),50) )) || 
      !living(target) )
  {
  ...
  else if( random( atoi(count_div(me->query("combat_exp"), 100)) ) > random( atoi(count_div(target->query("combat_exp"), 150)) )
