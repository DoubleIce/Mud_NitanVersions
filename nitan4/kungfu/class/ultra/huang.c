...
int give_quest()
{
    ...
    */
    ...
    if((time()-me->query("quesths_giveup_time")) < 20 + giveup*2)
    {
        ...
        if (me->query("quesths_times") < 3
        ||  (me->query("quesths_times") > 5 && random(20) == 5))
        {
...
//    message_vision("$N将$n交给黄裳。\n",me,ob);与give信息重复haiyan
   ...
   quest_count = me->query("quesths_times") + 1;
   ...
   me->set("quesths_times", quest_count);
   ...
   {
       obj = new("/clone/enchase/maggem.c");
