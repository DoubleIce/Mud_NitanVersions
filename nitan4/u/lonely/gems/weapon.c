...
if ((int)victim->query("jing")+50 > damage)
{
	...
	case "emerald":
		if (!victim->query_condition("emerald_poison")) {
			...
			victim->apply_condition("emerald_poison", victim->query_condition("emerald_poison") + random(5) + 3);
			victim->set("emerald_poison", socket_level);
			victim->apply_condition("snake_poison", victim->query_condition("snake_poison") + random(5) + 3);
			victim->apply_condition("zhizhu_poison", victim->query_condition("zhizhu_poison") + random(5) + 3);
			victim->apply_condition("wugong_poison", victim->query_condition("wugong_poison") + random(5) + 3);
			victim->apply_condition("xiezi_poison", victim->query_condition("xiezi_poison") + random(5) + 3);
			victim->apply_condition("chanchu_poison", victim->query_condition("chanchu_poison") + random(5) + 3);
