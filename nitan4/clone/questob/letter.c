...
int do_accept(string arg)
{
        ...
        if (me->query("quest/id") != query("killed_id"))
        ...
        {                
            if (QUEST_D->remote_bonus(me))
            {
                    ...
                    if (objectp(head = present("head", me)) &&
                        head->query("owner_id") == query("killed_id"))
                    {
