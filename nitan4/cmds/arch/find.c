...
public array search_file(string file, array flist, object me, int raw);
public array deep_file_list(string dir);
...
array search_file(string file, array flist, object me, int raw)
{
        int i, j;
        array result = ({ });
        string file_info;
