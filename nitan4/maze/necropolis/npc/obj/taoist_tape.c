...
/*
                        speaker->set("qi",speaker->query("max_qi")/2);
                        speaker->set("eff_qi",speaker->query("max_qi")/2);
                        speaker->set("jing",speaker->query("max_jing")/2);
                        speaker->set("eff_jing",speaker->query("max_jing")/2);
