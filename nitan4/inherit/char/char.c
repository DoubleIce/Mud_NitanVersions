...
void heart_beat()
{
        ...
        {
                me->add("time_reward/study", -1);
                if (me->query("time_reward/study") < 1)
                        me->delete("time_reward/study");
        }
        
        if (me->query("time_reward/quest"))
        {
                me->add("time_reward/quest", -1);
                if (me->query("time_reward/quest") < 1)
                        me->delete("time_reward/quest");
        }
...
int visible(object ob)
{
        ...
        if (! wizardp(ob))
        {
                ...
                if (ob->query_temp("apply/shade_vision"))
                {
...
varargs array set_idname(string id, string name)
{
        string text;
