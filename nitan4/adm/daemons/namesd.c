...
protected nosave nomask array key_sur = ({ });
protected nosave nomask array key_fname = ({ });
protected nosave nomask array key_mname = ({ });
...
nomask array query_s_name(string str)
{       
        if( str )
                return sur_name[str];
...
nomask array query_m_name(string str)
{       
        if( str )
                return m_name[str];
...
nomask array query_f_name(string str)
{       
        if( str )
                return f_name[str];
...
protected nomask array selete_namestring(string key, int sex)
{ 
        if( sex )
                return f_name[key]; 
        return m_name[key];
