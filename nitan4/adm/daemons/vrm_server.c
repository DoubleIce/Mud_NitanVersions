...
nosave array valid_dirs = ({ "south","north","west","east" });
...
/***************** 迷宫的一些预设特性：*****************/
nosave int l;                           // 迷宫的单边长
nosave array inherit_rooms = ({});      // 迷宫允许继承的档案名称
nosave array valid_rooms = ({});        // 迷宫可使用的房间文件名 (****)
...
nosave array maze_room_desc = ({});     // 迷宫房间的长描述
...
nosave array unique_rooms = ({});       // 迷宫唯一的房间
nosave array special_rooms = ({});      // 迷宫特殊的房间
