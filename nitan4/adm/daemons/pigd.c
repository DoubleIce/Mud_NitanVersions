...
array suit_char = ({ "S", "H", "D", "C" });
array suit_str = ({ "黑桃", "红心", "方块", "梅花" });
array rank_char = ({ "2", "3", "4", "5", "6", "7", "8", "9", "T", "J", "Q", "K", "A" });
array rank_str = ({ "２", "３", "４", "５", "６", "７", "８", "９", "⒑", "Ｊ", "Ｑ", "Ｋ", "Ａ" });
array seat_char = ({ "N", "W", "S", "E" });
array seat_str = ({ "北", "西", "南", "东" });
