...
// 查询帮派中的弟兄 
public array query_bunch_members(mixed ob)
{
        array member;
        string fname;
...
// 查询帮派中的地盘
public array query_bunch_areas(mixed ob)
{
        array areas, aname;
        string fname, afile;
...
public array query_bunch_league(mixed ob)
{
        array member;
        string fname;
