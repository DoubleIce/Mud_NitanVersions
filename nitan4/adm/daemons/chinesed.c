...
// some constatns
nosave array c_digit = ({ "零","十","百","千","万","亿","兆" });
nosave array c_num = ({ "零","一","二","三","四","五","六","七","八","九","十" });
nosave array c_num2 = ({ "零","壹","贰","参","肆","伍","陆","柒","捌","玖","什" });
nosave array sym_tian = ({ "甲","乙","丙","丁","戊","己","庚","辛","壬","癸" });
nosave array sym_di = ({ "子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥" });
// 最大数值单位可自由增减
// array unit = ({ "万","亿","兆","京","垓","杼","穣","沟","涧","正","载","极","恒河沙","阿僧祇","那由它","不可思议","无量","大数" });
nosave array unit = ({ "万","亿","兆" });
...
在求当前时间时用localtime是无所谓，但是要转换一个时间还是ctime好点！*/
        ...
        array month_name = ({"Jan","Feb","Mar","Apr","May","Jun","Jul",
                "Aug","Sep","Oct","Nov","Dec"});
        array week_name = ({"Mon","Tue","Wed","Thu","Fri","Sat","Sun"});
