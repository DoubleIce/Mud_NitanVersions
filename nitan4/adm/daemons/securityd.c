...
array query_wiz_levels() { return wiz_levels; }

array query_wizlist() { return keys(wiz_status); }
...
array get_wizlist() { return keys(wiz_status); }
...
int valid_write(string file, mixed user, string func)
{
	...
	&& (func == "save_object" || func == "write_file"))
        ...
        if (func == "save_object")
        {
                ...
                if (sscanf(file, "/data/fairyland/%*s")) return 1;
        }
