...
{ 
        ...
        //迷宫房间里的怪物。 
        set_maze_npcs( ([
                "/d/maze/prison/npc/qiutu1": 1 + random(2),
                "/d/maze/prison/npc/qiutu2": 1 + random(2),
                "/d/maze/prison/npc/qiutu3": 1 + random(2),
                "/d/maze/prison/npc/jinyiwei": 1 + random(2),
        ]) );                   

        set_exit_npcs( "/d/maze/prison/npc/laotou" );
        //不算死亡              
        //set_no_death_room(1);
