	...
	switch (index)  {
		...
		case(6):
			...
			speaker->set("bellicosity",50000);
                        /*
			speaker->set("qi",speaker->query("max_qi"));
			speaker->set("eff_qi",speaker->query("max_qi"));
			speaker->set("jing",speaker->query("max_jing"));
			speaker->set("eff_jing",speaker->query("max_jing"));
...
void play_sound_8(string dir,int index) {
	...
	switch (index)  {
		...
		case(1):
			...
			break;
		case(2):
			MAZE_D->remove_virtual_maze(killer, "necropolis") 
			destruct(this_object());
			return;
			break;
		*/
