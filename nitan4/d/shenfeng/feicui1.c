...
void create()
{
        set("short", "翡翠池");
        set("long", @LONG
这里四周群山围绕，就如一只大盆一般，盆子中心碧水莹然，绿
若翡翠，是个圆形的大水池(pool)，隔了这千百年，竟然并不曾干枯，
想来池底另有活水源头。你走近池边，伸下手去只觉清凉入骨，双手
捧起水来但见池水澄净清澈，更无纤毫苔泥，原来圆池四周都是翡翠，
池水才映成绿色。只见洁白的玉峰映在碧绿的池中，明艳洁净，幽绝
清绝。
LONG );
