...
#define CANGKU "/d/sjszhuang/cangku"


// I put all possible npcs at here!
string *high_npc = ({
	 "/kungfu/class/ouyang/ouyangfeng",
	 "/kungfu/class/emei/miejue",
	 "/kungfu/class/emei/zhou",
	 "/kungfu/class/gaibang/hong",
	 "/kungfu/class/huashan/ai-laozhe",
	 "/kungfu/class/huashan/gao-laozhe",
...
string *special_weapon = ({
		  "/d/sjszhuang/obj/hunterbow.c",
		  "/d/sjszhuang/obj/arrow.c",
		  "/d/sjszhuang/obj/dantou.c",
		  "/d/sjszhuang/obj/huoyao.c",
...
void my_destruct(object obj)
{
        ...
        if (obj && objectp(obj) ) {
	        ...
	        while(i--)
	        {
		        ...
		        {
			        call_out("move_me",1+random(4),inv[i],"/d/sjszhuang/kantai_w1.c");
	        ...
	        if( userp(obj) )
	        {
		        call_out("move_me",1+random(4),obj,"/d/sjszhuang/kantai_w1.c");
        ...
        if (obj = find_object(file)) {
		        ...
		        if( inv[i] && objectp(inv[i]) && userp(inv[i]) )
			{
			        if( !living(inv[i]) || inv[i]->query("qi") <= 0 )
			        {
				        ...
				        {
					        call_out("move_me",1+random(4),inv[i],"/d/sjszhuang/west_xiangfang.c");
				        }
				        else if( inv[i]->query("sjsz/white") )
					{
				                call_out("move_me",1+random(4),inv[i],"/d/sjszhuang/east_xiangfang.c");
			                }
				        if( !living(inv[i]) )inv[i]->revive(1);
				        full_all(inv[i]);
				        nude(inv[i]);
...
void make_npc(object room)
{
	 ...
	 if (random(2) == 1) {
		 ob = new("/d/sjszhuang/obj/renshen-guo");
	 }
	 else if (random(20) == 1) {
		 ob = new("/d/sjszhuang/obj/bomb");
	 }
	 else
	 {
...
void refresh_sjsz()
{
	 ...
	 refresh_room("/d/sjszhuang/wgate.c");
	 refresh_room("/d/sjszhuang/wgarden.c");
	 refresh_room("/d/sjszhuang/wtang.c");
	 refresh_room("/d/sjszhuang/wting.c");
	 refresh_room("/d/sjszhuang/wzoulan.c");
	 refresh_room("/d/sjszhuang/egate.c");
	 refresh_room("/d/sjszhuang/egarden.c");
	 refresh_room("/d/sjszhuang/etang.c");
	 refresh_room("/d/sjszhuang/eting.c");
	 refresh_room("/d/sjszhuang/ezoulan.c");

	 refresh_room("/d/sjszhuang/etower1.c");
	 refresh_room("/d/sjszhuang/etower2.c");
	 refresh_room("/d/sjszhuang/etower3.c");
	 refresh_room("/d/sjszhuang/etower4.c");
	 refresh_room("/d/sjszhuang/etower5.c");
	 refresh_room("/d/sjszhuang/etower6.c");
	 refresh_room("/d/sjszhuang/etower7.c");

	 refresh_room("/d/sjszhuang/wtower1.c");
	 refresh_room("/d/sjszhuang/wtower2.c");
	 refresh_room("/d/sjszhuang/wtower3.c");
	 refresh_room("/d/sjszhuang/wtower4.c");
	 refresh_room("/d/sjszhuang/wtower5.c");
	 refresh_room("/d/sjszhuang/wtower6.c");
	 refresh_room("/d/sjszhuang/wtower7.c");


	 for(r=1;r<=30;r++){
		  if (r < 10)
		  {
				rm = "/d/sjszhuang/room_0" + sprintf("%d", r);
				room = find_object(rm);
				if(!room) load_object(rm);
			}
		  else
		  {
				rm = "/d/sjszhuang/room_" + sprintf("%d", r);
				room = find_object(rm);
				if( !room ) load_object(rm);
		  }
		  if(!room) continue;
...
void clean_sjsz()
{
	...
	for ( i = 1; i <= 30; i++) {
			if (i < 10)
			{
			 update_room("/d/sjszhuang/room_0" + sprintf("%d", i));
			 room = find_object("/d/sjszhuang/room_0" + sprintf("%d", i));
			}
			else
			{
			 update_room("/d/sjszhuang/room_" + sprintf("%d", i));
			 room = find_object("/d/sjszhuang/room_" + sprintf("%d", i));
			}

			if( room && objectp(room) )
					 destruct(room);
	}
	update_room("/d/sjszhuang/wgate.c");
	update_room("/d/sjszhuang/wgarden.c");
	update_room("/d/sjszhuang/wtang.c");
	update_room("/d/sjszhuang/wting.c");
	update_room("/d/sjszhuang/wzoulan.c");
	update_room("/d/sjszhuang/egate.c");
	update_room("/d/sjszhuang/egarden.c");
	update_room("/d/sjszhuang/etang.c");
	update_room("/d/sjszhuang/eting.c");
	update_room("/d/sjszhuang/ezoulan.c");
	update_room("/d/sjszhuang/west_xiangfang.c");
	update_room("/d/sjszhuang/east_xiangfang.c");
        update_room("/d/sjszhuang/etower1.c");
	update_room("/d/sjszhuang/etower2.c");
	update_room("/d/sjszhuang/etower3.c");
        update_room("/d/sjszhuang/etower4.c");
	update_room("/d/sjszhuang/etower5.c");
	update_room("/d/sjszhuang/etower6.c");
	update_room("/d/sjszhuang/etower7.c");

	update_room("/d/sjszhuang/wtower1.c");
        update_room("/d/sjszhuang/wtower2.c");
	update_room("/d/sjszhuang/wtower3.c");
	update_room("/d/sjszhuang/wtower4.c");
	update_room("/d/sjszhuang/wtower5.c");
	update_room("/d/sjszhuang/wtower6.c");
	update_room("/d/sjszhuang/wtower7.c");
...
int do_duet(string arg)
{
	 ...
	 case "start" :
						  ...
						  room = find_object("/d/sjszhuang/wtang");
						  if(!room)room = load_object("/d/sjszhuang/wtang");
						  room->set("flag",1);
						  room->set("team_name",board->query("westname") );
						  room = find_object("/d/sjszhuang/etang");
						  if(!room)room = load_object("/d/sjszhuang/etang");
						  room->set("flag",1);
...
int do_judge(string arg) {
	 ...
	 rum_ob = load_object("/adm/npc/referee");
	 if(objectp(rum_ob))
	 {
...
int update(int n, int result) {
	...
	for ( i = 0; i < sizeof(board->query( "team/" + sprintf("%d", n) + "/ids")); i++) {
								...
								if( player->query("sjsz/white") )
								 call_out("move_me",1+random(16),player,"/d/sjszhuang/kantai_e1.c");
								else call_out("move_me",1+random(16),player,"/d/sjszhuang/kantai_w1.c");
	...
	for ( i = 0; i < sizeof(board->query( s + "/ids")); i++) {
	 ...
	 case "east" :
						...
						for ( i = 0; i < sizeof(board->query( s + "/ids")); i++) {
								...
								player->delete("sjsz/this_flag");
								player->delete("sjsz/this_exp");
								call_out("move_me",3+random(10),player,"/d/sjszhuang/east_xiangfang.c");
								if( !living(player) ) player->revive(1);
								full_all(player);
	 ...
	 case "west" :
						...
						for ( i = 0; i < sizeof(board->query( s + "/ids")); i++) {
								...
								player->delete("sjsz/this_flag");
								player->delete("sjsz/this_exp");
								call_out("move_me",3+random(10),player,"/d/sjszhuang/west_xiangfang.c");
								if( !living(player) ) player->revive(1);
								full_all(player);
								//message_vision("主持人运气一掌把$N送进试剑山庄。\n",player);
						  }
...
int do_add(string arg) {
	 ...
	 if( count_lt(me->query("combat_exp"), 500000) )return notify_fail("主持人怒道：你武功这么差，岂配当队长？\n");
	 ...
	 for(i = 0; i < 20; i++) {
		  ...
		  if( count_lt(player->query("combat_exp"), 80000) ) return notify_fail("主持人怒道："+player->query("name")+"武功这么差，不配在试剑山庄舞剑。\n");
		  for(j=0;j<i;j++)
		  {
			 if(user[j] == user[i])
				return notify_fail(player->query("name") + "已经是" + player->query("sjsz/team_name")+"的了。\n");
	 ...
	 for(i = 0; i < 20; i++) {
		  ...
		  exp = count_add(exp, player->query("combat_exp"));
		  msg = msg + player->query("name") + " ";
	 }

	 if( count_lt(exp, 1000000) )
	 {
		  board->delete("team/" + sprintf("%d",total));
		  for(i = 0; i < 20; i++)
		  {
...
int do_auto_teamup(string arg) {
	 ...
	 string msg = "";
	 int ppl=0, i,j;
	 mixed exp, exp1,exp2,sum_exp,top_exp,sec_exp;
	 ...
	 if( count_lt(me->query("combat_exp"), 500000) )return notify_fail("主持人怒道：你武功这么差，岂配指挥老子？\n");
	...
	{
		 i--;
	  if( inv[i] && objectp(inv[i]) && living(inv[i]) && userp(inv[i]) && count_gt(inv[i]->query("combat_exp"), 80000) )
	  {
		  exp = inv[i]->query("combat_exp"); 
		  if( count_gt(exp, top_exp) )
		  { 
			sec_exp=top_exp; sec_id = top_id; 
			top_exp = exp; top_id = inv[i]->query("id");
		  }
		  if( count_gt(exp, sec_exp) && count_lt(exp, top_exp) ){ sec_exp=exp; sec_id = inv[i]->query("id"); }
		  sum_exp = count_add(sum_exp, exp);
		  inv[i]->delete("sjsz");
		  ppl++;
	  }
	 }
	 ...
	 while(i)
	{
	  ...
	  if( inv[i] && objectp(inv[i]) && living(inv[i]) && userp(inv[i]) && count_gt(inv[i]->query("combat_exp"), 80000) )
	  {
		  ...
		  if(count_gt(exp1, exp2) && random(4) != 1)
		  {
			  team2 += " "+inv[i]->query("id");
			  exp2 = count_add(exp2, exp);
			  inv[i]->delete("sjsz");
