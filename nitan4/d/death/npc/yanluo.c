...
mixed ask_quest()
{
        ...
        if ( ! me->is_ghost() && ! wizardp(me) && ! me->query("reborn_offer"))
                return "咦？阳人怎么到这里来了？";
        ...
        */
        ...
        if (count_lt(me->query("combat_exp"), 2000000000))
...
mixed ask_reborn()
{
        ...
        if (! who->query("reborn_offer") || who->query("reborn_offer") != "finish")
        {
