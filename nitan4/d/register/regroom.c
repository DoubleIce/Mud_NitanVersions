...
{
        set("short", "×¢²á·¿¼ä");
        set("long", "\n    ÕâÀïÊÇÐÂÍæ¼Ò½øÐÐ×¢²áµÄµØ·½£¬ÇëÄúÊ¹ÓÃÃüÁî " HIC "register " NOR "¼ÓÉÏÄã\n"
                    "µÄ" HIC "µç×ÓÓÊ¼þµØÖ·" NOR "½øÐÐ×¢²á(" HIW "register lonely-21@163.com" NOR ")¡£\n\n"
                    "    ÇëÎñ±ØÈÏÕæ×¢²áÄãµÄµç×ÓÓÊ¼þµØÖ·£¬" HIR "µç×ÓÓÊ¼þµØÖ·ÊÇ±£ÕÏÄãÒ»ÇÐ\n"
                    "È¨ÒæµÄÒÀ¾Ý" NOR "£¬°üÀ¨ÄãÃÜÂëµÄ¶ªÊ§Çé¿öÏÂ£¬ÎÒÃÇÍ¨¹ýÄã×¢²áµÄÐÅÏäÀ´È·\n"
                    "ÈÏÄãµÄÉí·ÝºÍ¹é»¹ÄãµÄÃÜÂë¡£\n");
