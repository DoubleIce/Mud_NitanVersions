...
int accept_object(object me, object ob) 
{
        ...
        if( !me->query_temp("mibao/to_find") )
                return 0;

        if( !me->query_temp("mibao/finded") )
                return 0;
        ...
        me->set_temp("can_offer", this_object()->query("id"));
